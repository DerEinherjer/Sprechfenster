...
public interface iRound {
   ...
   * @return Returns if the slot was free and the time is set arcording to the
   * parameters.
   ...
   * hes is not allready part of it.
   *
   ...
   * the first one participates and the second one do not.
   *
