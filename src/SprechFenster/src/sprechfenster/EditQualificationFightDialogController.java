 ...
 * @author Stefan
 */
public class EditQualificationFightDialogController implements Initializable
{
    ...
    public void SetData(iPreliminary fight, iTournament tournament)
    {
        Fight = fight;
